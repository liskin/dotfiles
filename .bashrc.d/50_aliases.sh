...
alias urxvt-setfont-iosevka-fixed='urxvt-setfont "Iosevka Fixed SS18"'
...
export-alias alacritty-iosevka="alacritty -o 'font.normal.family=\"Iosevka Fixed SS18\"' -o 'font.size=9'"
export-alias alacritty-iosevka-big="alacritty -o 'font.normal.family=\"Iosevka Fixed SS18\"' -o 'font.size=14'"
...
export-alias google-chrome-app-goblin-tools-compiler="google-chrome --app=https://goblin.tools/Compiler"
export-alias google-chrome-app-goblin-tools-estimator="google-chrome --app=https://goblin.tools/Estimator"
export-alias google-chrome-app-goblin-tools-formalizer="google-chrome --app=https://goblin.tools/Formalizer"
export-alias google-chrome-app-goblin-tools-judge="google-chrome --app=https://goblin.tools/Judge"
...
export-alias nmcli-c-up-bluetooth='nmcli device connect 18:69:D4:0A:F6:0E'
export-alias nmcli-c-down-bluetooth='nmcli device disconnect 18:69:D4:0A:F6:0E'
